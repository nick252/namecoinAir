...
package vk.gui
{
  ...
  */
  public class Utils
  {
	...
	public static function fillRRectUsachev( obj:*, x:int, y:int, w:uint, h:uint, c:int, r:int):void
	{
		//var tt:Sprite = new Sprite()
		obj.graphics.clear()	
			
		obj.graphics.lineStyle();
		obj.graphics.beginFill( c, 0.7 );
		obj.graphics.drawRoundRect( x, y, w, h, r );
		obj.graphics.endFill();
	}
	
	public static function fillRRectNikola(bit:BitmapData, obj:*):void
	{
		//obj.graphics.lineStyle();
	//	obj.graphics.beginFill( c, alpha );
		//obj.graphics.drawRoundRect( x, y, w, h, r );
	...
	obj.graphics.beginBitmapFill(bit)
	obj.graphics.drawRect( 1, 0, 183, 25);
	obj.graphics.endFill();	
