  ...
  */
  public class MainMenu extends Sprite
  {
    ...
    public function MainMenu( wrapper:*, lazyMode:Boolean = false ):void
    {
     ...
     // Utils.fillRect( this, 0, 0, WIDTH, HEIGHT, 0x575757 );
      //добавим выше меню
	new Loader
	  ...
	  //var req:URLRequest=new URLRequest('http://vpanorame.ru/upmeny.png');
	 // var ldrContext:LoaderContext=new LoaderContext(false, ApplicationDomain.currentDomain, SecurityDomain.currentDomain);
	 // var ldr1:Loader =new Loader();
	//  ldr1.load(req, ldrContext);
	//  addChild(ldr1);
	...
	//  menuItem.button.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):void{
		//  e.currentTarget.H = 15
//	})
